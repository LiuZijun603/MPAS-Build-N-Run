...
mesh_dir="/data/ess-liuzj/mpas_tutorial/mesh/240km/"
...
static_file_true=0 # 1: static.nc exist; 0: no static.nc 
...
cp /data/ess-liuzj/0907case/test/60-3km/stream_list.atmosphere.* .
...
##########################You should change "/15km/x1.10242.grid.nc"
echo '
<streams>
<immutable_stream name="input"
                  type="input"
                  filename_template="/data/ess-liuzj/mpas_tutorial/mesh/240km/x1.10242.grid.nc"
...
cp x1.10242.static.nc ${mesh_dir}
fi

echo 'static file is ok'
...
##########################You should change the (1)"x1.10242.init.nc"
echo '
<streams>
<immutable_stream name="input"
                  type="input"
...
gpmetis -minconn -contig -niter=200 x1.10242.graph.info 40

cd -
##########################You should change the (1)"x1.10242.init.nc"
ln -s ${mesh_dir}"x1.10242.graph.info.part.40" .
