#Your test dir
Test_dir="/data/ess-liuzj/0907case/test/15km/"
mesh_dir="/data/ess-liuzj/mpas_tutorial/mesh/15km/"
...
##########################You should change "/15km/x1.2621442.grid.nc"
echo '
<streams>
<immutable_stream name="input"
                  type="input"
                  filename_template="/data/ess-liuzj/mpas_tutorial/mesh/15km/x1.2621442.grid.nc"
...
##########################You should link your init data
ln -s /data/ess-liuzj/gfs/2023_09-07_08/GFS\:2023-09-0* .

##########################You should change the (1)start time, (2)config_nvertlevels, 55 as usual
...
#This command do not need change. cp the var file and link scheme file
...
##########################You should change the (1)"x1.2621442.init.nc"
echo '
<streams>
<immutable_stream name="input"
                  type="input"
...
cd ${mesh_dir}
##########################You should change the (1)"x1.2621442.init.nc"
##########################(2) 240 is the num of cores
gpmetis -minconn -contig -niter=200 x1.2621442.graph.info 240

cd -
##########################You should change the (1)"x1.2621442.init.nc"
ln -s ${mesh_dir}"x1.2621442.graph.info.240" .
