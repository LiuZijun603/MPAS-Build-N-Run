...
rm -rf regional_GFS_3km_big
mkdir regional_GFS_3km_big
cd regional_GFS_3km_big

ln -s /work/ess-liuzj/MPAS-Model-7.0/init_atmosphere_model .
ln -s /work/ess-liuzj/MPAS-Model-7.0/atmosphere_model .
ln -s /data/ess-liuzj/mpas_tutorial/mesh/3km/x1.65536002.static.nc .
...
./create_region shenzhen.pts x1.65536002.static.nc
gpmetis -minconn -contig -niter=200 shenzhen.graph.info 40
gpmetis -minconn -contig -niter=200 shenzhen.graph.info 240
...
&decomposition
    config_block_decomp_file_prefix = 'shenzhen.graph.info.part.'
/
...
<immutable_stream name="input"
                  type="input"
                  filename_template="shenzhen.static.nc"
                  io_type="pnetcdf,cdf5"
                  input_interval="initial_only" />

<immutable_stream name="output"
                  type="output"
                  filename_template="shenzhen.init.nc"
                  io_type="pnetcdf,cdf5"
